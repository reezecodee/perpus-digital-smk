<x-borrower-layout :title="$title" :bubble="false">
    <div class="flex flex-col justify-center items-center h-screen text-center">
        <img src="/img/assets/success.webp" alt="" srcset="" width="350">
        <div>
            <h1 class="text-center font-bold text-2xl block mb-3">Peminjaman sukses, terimakasih sudah menggunakan
                layanan
                kami</h1>
