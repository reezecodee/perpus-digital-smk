            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('add_category') }}" method="POST" id="add-form">
                        @csrf
                        <x-librarian.input.basic label="Nama kategori" name="nama_kategori" :value="old('nama_kategori')"
                        ...
                        <tbody>
                            @foreach ($categories as $item)
                                <tr>
                                    ...
                                    <td align="center">
                                        <x-librarian.button.edit :route="route('edit_category', $item->id)" />
                                        <x-librarian.button.delete :id="$item->id" :route="route('delete_category', $item->id)" />
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
