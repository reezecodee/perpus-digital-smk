                    ...
                    <div class="col-lg-7">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <x-librarian.input.basic label="Username" name="username" :value="old('username', auth()->user()->username)"
                                            placeholder="Masukkan username" type="text" :isrequired="true" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12">
                                        <x-librarian.input.basic label="Nama lengkap" name="nama" :value="old('nama', auth()->user()->nama)"
                                            placeholder="Masukkan nama lengkap" type="text" :isrequired="true" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12">
                                        <x-librarian.input.basic-disable label="Jabatan" name="jabatan"
                                            :value="auth()->user()->getRoleNames()->implode(', ')" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12">
                                        <x-librarian.input.basic label="Nomor Induk Pegawai" name="nip_nis"
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <x-librarian.input.basic label="Nomor telepon" name="telepon" :value="old('telepon', auth()->user()->telepon)"
                                            placeholder="Masukkan nomor telepon" type="number" :isrequired="true" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12">
                                        <x-librarian.input.basic label="Email" name="email" :value="old('email', auth()->user()->email)"
                                            placeholder="Masukkan email" type="email" :isrequired="true" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12">
                                        <x-librarian.input.select label="Jenis kelamin" name="jk"
                                            :options="['Laki-laki', 'Perempuan']" :selectedvalue="auth()->user()->jk ?? ''" :isrequired="true"
                                            placeholder="Pilih jenis kelamin" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12">
                                        <x-librarian.input.textarea label="Alamat" name="alamat" :value="old('alamat', auth()->user()->alamat)"
