                            ...
                            <form action="{{ route('upload_carousel') }}" method="post" id="add-form"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" id="fileInput"
                                        class="image @error('image') is-invalid @enderror" name="image"
                                        class="image">
                                    @error('image')
                                ...
                                <button type="button" onclick="confirmAdd()" class="btn btn-primary"><i
                                        class="fas fa-plus"></i>
                                    Tambahkan</button>
                                <a href="{{ route('show.cropPicture') }}" target="_blank">
                                ...
                                <tbody>
                                    @foreach ($carousels as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <x-librarian.button.delete :id="$item->id" :route="route('delete_carousel', $item->id)" />
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
