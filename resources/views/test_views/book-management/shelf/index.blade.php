                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" value="{{ old('nama_rak') }}" class="form-control @error('nama_rak') is-invalid @enderror"
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" value="{{ old('kode') }}" class="form-control @error('kode') is-invalid @enderror"
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-2">
                                    ...
                                    <input type="number" value="{{ old('kapasitas') }}" class="form-control @error('kapasitas') is-invalid @enderror"
