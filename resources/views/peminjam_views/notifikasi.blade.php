            ...
            <div class="flex">
                <div class="self-start w-full border shadow-md rounded-md p-4">
                    ...
                    <div class="border rounded-lg p-2 mb-3">
                        <div>
                            <a href="">
                                <h1 class="text-lg font-bold leading-5 lg:leading-none">Lorem ipsum dolor sit amet, consectetur adipisicing
                                    elit.
                                    Non, totam.</h1>
                            </a>
                            <p class="text-xs lg:text-sm">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsam
                                voluptate
                                exercitationem nostrum nulla.</p>
