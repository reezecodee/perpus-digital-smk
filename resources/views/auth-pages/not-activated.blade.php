<x-auth-layout :title="$title">
    <div>
        ...
        <div class="text-center">
            ...
            <a href="/">
                <button
                    class="p-3 max-w-sm w-full border-2 border-red-primary text-red-primary font-bold hover:bg-red-500 hover:text-white hover:border-red-500 duration-300">Kembali</button>
            </a>
        </div>
    </div>
</x-auth-layout>
