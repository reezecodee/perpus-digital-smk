                ...
                <form method="post">
                    ...
                    <div class="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50">
                        ...
                        <div class="flex items-center justify-between px-3 py-2 border-t">
                            <x-peminjam.button.confirm-btn :nomargin="true" modaltarget="review-modal-{{ $iteration }}">
                                Berikan komentar
                            </x-peminjam.button.confirm-btn>
                        </div>
                    </div>

                    <x-peminjam.modal.confirm-modal question="Apakah Anda yakin ingin memberikan komentar terhadap buku ini?. Komentar yang dikirimkan tidak dapat di ubah lagi" okbtn="Ya, tentu"
                        nobtn="Batalkan" modalname="review-modal-{{ $iteration }}" />
                </form>
            </div>
        </div>
    </div>
