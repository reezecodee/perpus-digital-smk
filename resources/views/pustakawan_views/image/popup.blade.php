        ...
        <div class="col-md-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('upload_popup') }}" method="post" id="add-form" enctype="multipart/form-data">
                        @csrf
                        ...
                        <tbody>
                            @foreach ($popups as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->link }}</td>
                                    <td>
                                        <x-pustakawan.button.delete :id="$item->id" :route="route('delete_popup', $item->id)" />
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
