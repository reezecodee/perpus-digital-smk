    ...
    <div class="card">
        <div class="card-body">
            <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="nisn" value="{{ old('nisn', $data->nisn ?? '') }}"
                                    placeholder="Masukkan NIP" class="form-control @error('nisn') is-invalid @enderror"
                                    required>
                                @error('nisn')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                ...
                <div class="mt-3">
                    <button type="submit" onclick="upload()" class="btn btn-primary">Simpan data peminjam</button>
                </div>
            </form>
        </div>
    </div>
