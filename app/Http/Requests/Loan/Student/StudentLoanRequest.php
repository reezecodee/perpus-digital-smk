...
namespace App\Http\Requests\Loan\Student;

use Illuminate\Foundation\Http\FormRequest;

class StudentLoanRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'keterangan_denda' => 'nullable|min:10|max:200',
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'keterangan_denda.min' => 'Keterangan harus memiliki minimal 10 karakter.',
            'keterangan_denda.max' => 'Keterangan tidak boleh lebih dari 200 karakter.',
        ];
    }
}
