...
namespace App\Http\Controllers\Pustakawan\Help;
...
class ManageHelp extends Controller
{
    ...
    {
        return view('pustakawan_views.bantuan.index', [
            'title' => 'Pusat Bantuan',
    ...
    public function show_detail_help($id)
    {
        ...
        return view('pustakawan_views.bantuan.detail', [
    ...
    public function print_help_report(PDF $pdf, $id)
    {
        ...
        $pdf_instance = $pdf->loadView('pustakawan_views.generate.pdf_laporan.help-report', compact('data'));
