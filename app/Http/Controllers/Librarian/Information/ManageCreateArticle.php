...
class ManageCreateArticle extends Controller
{
    ...
    {
        return view('librarian-pages.information.create-article', [
            'title' => 'Buat Artikel',
    ...
    {
        return view('librarian-pages.information.my-articles', [
            'title' => 'Artikel Saya',
    ...
    public function show_edit_article($id)
    {
        ...
        return view('librarian-pages.information.edit-article', [
            'title' => 'Edit Artikel',
