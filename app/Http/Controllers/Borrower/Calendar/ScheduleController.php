...
{
    /**
     * Function ini digunakan untuk menampilkan halaman kalender perpustakaan.
     * 
     */

    public function showCalendarPage()
    {
        $title = 'Jadwal & Pengembalian Buku Perpustakaan';

        return view('borrower-pages.calendar.schedules', compact('title'));
    }
    ...
    public function events()
    {
        ...
        $userLoans = $this->getUserLoanSchedules();
    ...
    private function getUserLoanSchedules()
    {
