...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('loans', function (Blueprint $table) {
            ...
            $table->enum('status', ['Masa pinjam', 'Masa pengembalian', 'Terkena denda', 'Sudah dikembalikan', 'Sudah dibayar', 'Sudah diulas', 'Menunggu persetujuan', 'Ditolak', 'Menunggu diambil', 'E-book', 'E-book sudah diulas', 'Dibatalkan'])->default('Menunggu persetujuan');
